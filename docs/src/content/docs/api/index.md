...
- [CreatedState](/api/interfaces/createdstate/)
...
- [UpdateOptions](/api/interfaces/updateoptions/)
- [UpdatedState](/api/interfaces/updatedstate/)
...
- [getSymbolAction](/api/functions/getsymbolaction/)
- [handler](/api/functions/handler/)
- [manyHandler](/api/functions/manyhandler/)
- [oneHandler](/api/functions/onehandler/)
...
Renames and re-exports [Handler](/api/classes/handler/)
