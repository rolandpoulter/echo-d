 ...
 */
export const SymbolActionsFactory = (Parent: any = Object): any => class SymbolActions extends Parent {
    /**
     ...
     */
    addSymbol(symbol: any, context: Context, options: Options | any) {
     ...
     */
    fetchSymbol(payload: string | number, context: Context, options: Options | any) {
        options = options = Options.ensure(options, this)
        const { responder, enumDefaultSymbols } = options

        return context.fetchSymbol(payload, options, (symbolTuple: any) => {
     ...
     */
    getSymbol(index: number, context: Context, options: Options | any) {
        options = options = Options.ensure(options, this)
     ...
     */
    mergeSymbol(payload: [string, number], context: Context, options: Options | any) {
        options = options = Options.ensure(options, this)
     ...
     */
    mergeSymbols(payload: any[], context: Context, options: Options | any) {
        options = options = Options.ensure(options, this)
     ...
     * @param {Options | any} options - The options for retrieving the symbol. If an instance of Options is not provided, a new one will be created.
     */
    symbol(symbol: any, context: Context, options: Options | any) {
        options = options = Options.ensure(options, this)
